...
def update_graph(
    ...
    return (
        ...
        fig5,
        fig6,
        f"# Total Feed Use Reduction over {months} months is {(total_feed_saved/1000000).round() } million tonnes from a baseline of {(baseline_total_feed/1000000).round()} million tonnes",
        # df_final
