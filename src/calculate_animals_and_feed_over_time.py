...
class CalculateAnimalOutputs:
    ...
    def calculate_feed_and_animals(
        ...
        feed_unit_adjust = (
            0.0005 * tons_to_kcals * kcals_to_billion_kcals
        )  # convert pounds to tons to billions of kcals
        ...
        plt.show()
        plt.figure()
        plt.plot(df_final["Poultry Pop"])
        plt.title("Poultry Pop")
        plt.show()
        plt.figure()
        plt.plot(df_final["Pigs Pop"])
        plt.title("Pigs Pop")
        plt.show()
        plt.figure()
        plt.plot(df_final["Beef Pop"])
        plt.title("Beef Pop")
        plt.show()
        plt.figure()
        plt.plot(df_final["Dairy Pop"])
        plt.title("Dairy Pop")
        plt.show()
        return df_final
